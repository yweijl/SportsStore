...
namespace SportsStore.Models
{
    public static class SeedData
    {
        public static IApplicationBuilder EnsurePopulated(this IApplicationBuilder app)
        {
            ...
            if (context.Products.Any()) return app;
            ...
            context.AddRange(
                ...
                new Product { Name = "Corner Flags", Description = "Give your playing fields a proffesional touch", Category = "Soccer", Price = 34.95m},
